        ...
        <div class="px-12 py-8">
            @if (session('success'))
                <div id="success-alert"
                    class="mb-6 flex items-center gap-3 bg-green-500/10 border border-green-500/20 text-green-600 px-6 py-4 rounded-xl animate-in fade-in slide-in-from-top-4 duration-300">
