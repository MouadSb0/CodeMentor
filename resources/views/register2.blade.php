...
<body
    class="bg-[#D0E3E6] font-body text-on-surface selection:bg-primary-container selection:text-on-primary-container min-h-screen flex flex-col">
    <!-- TopAppBar -->
    <header class="w-full top-0 z-50 bg-[#D0E3E6] dark:bg-[#0f172a] flex items-center justify-between px-6 py-4">
        <div class="flex items-center gap-4">
            <button
                class="text-[#006573] dark:text-[#22d3ee] active:scale-95 duration-200 hover:bg-[#eef1f3] dark:hover:bg-[#1e293b] transition-colors p-2 rounded-full">
                <a href="{{ url('/register') }}" class="material-symbols-outlined">arrow_back</a>
            </button>
            <span
                class="font-['Space_Grotesk'] font-bold tracking-tight text-3xl text-primary dark:text-white tracking-tighter">Back</span>
        </div>
    ...
    <main class="flex-grow relative overflow-hidden flex items-center justify-center py-12 px-6">
        <!-- Abstract Background Pattern -->
        <div class="absolute inset-0 kinetic-grid pointer-events-none"></div>
        <div
            class="absolute -top-24 -right-24 w-96 h-96 bg-primary-container/10 rounded-full blur-3xl pointer-events-none">
        </div>
        <div
            class="absolute -bottom-24 -left-24 w-96 h-96 bg-tertiary-container/10 rounded-full blur-3xl pointer-events-none">
        </div>
        <div class="relative w-full max-w-2xl">
            <div class="mb-10 flex flex-col items-start gap-4">
                <div class="inline-flex items-center px-4 py-1.5 rounded-full bg-primary/5 border border-primary/10">
                    <span class="text-xs font-bold tracking-widest text-primary font-headline uppercase">Step 3 of
                        3</span>
                </div>
            ...
            <!-- Form Container -->
            <div
                class="bg-surface-container-lowest rounded-xl p-8 shadow-[0_4px_20px_rgba(44,47,49,0.04)] shadow-[0_10px_40px_rgba(0,101,115,0.06)]">
                <form action="{{ route('register.complete') }}" method="POST" class="space-y-8">
                    @csrf
                    <!-- Professional Role -->
                    <div class="space-y-3">
                        <label class="block text-sm font-medium text-on-surface-variant ml-1" for="role">Professional
                            Role</label>
                    ...
                    <!-- Years of Experience -->
                    <div class="space-y-3">
                        <label class="block text-sm font-medium text-on-surface-variant ml-1">Years of
                            Experience</label>
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <label class="relative group cursor-pointer">
                                <input checked="" class="peer sr-only" name="experience" type="radio" />
                                <div
                                    class="px-4 py-3 rounded-xl bg-surface-container-low text-center font-medium text-sm transition-all peer-checked:bg-primary peer-checked:text-on-primary group-hover:bg-surface-container-high">
                                    0-1 Years</div>
                            </label>
                            <label class="relative group cursor-pointer">
                                <input class="peer sr-only" name="experience" type="radio" />
                                <div
                                    class="px-4 py-3 rounded-xl bg-surface-container-low text-center font-medium text-sm transition-all peer-checked:bg-primary peer-checked:text-on-primary group-hover:bg-surface-container-high">
                                    2-4 Years</div>
                            </label>
            ...
            <!-- Side Visual Element -->
            <div class="hidden lg:block absolute -right-64 top-1/2 -translate-y-1/2 w-48">
                <div class="flex flex-col gap-4">
                    <div class="w-12 h-1 bg-primary rounded-full"></div>
                    <div class="w-24 h-1 bg-primary/40 rounded-full"></div>
    ...
    <nav
        ...
        <a class="flex flex-col items-center justify-center bg-[#eef1f3] dark:bg-[#1e293b] text-[#006573] dark:text-[#22d3ee] rounded-xl px-4 py-1 transition-all duration-300 ease-out"
            href="#">
            <span class="material-symbols-outlined mb-1">steps</span>
            <span class="font-['Inter'] text-[10px] font-medium tracking-wide">Progress</span>
        </a>
        <a class="flex flex-col items-center justify-center text-[#abadaf] dark:text-[#64748b] px-4 py-1 hover:text-[#006573] dark:hover:text-[#22d3ee] transition-all duration-300 ease-out"
            href="{{ url('/contact') }}">
