...
<body class="bg-[#D0E3E6] text-on-surface min-h-screen">
        ...
        <div class="flex justify-between items-center px-4 py-3 max-w-7xl mx-auto">
            <div class="flex items-center gap-2">
                <a href="{{ url('/') }}" class="flex items-center gap-2">
                    ...
                    <span class="font-headline font-bold text-xl text-primary hidden sm:block">Kinetic Academy</span>
                </a>
            </div>
    ...
    <main class="max-w-7xl mx-auto px-6 py-12">
        <div class="flex flex-col md:flex-row gap-12">
            ...
            <aside class="hidden md:flex flex-col w-72 shrink-0">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-12 h-12 rounded-xl overflow-hidden shadow-sm">
                            <img alt="User avatar" class="w-full h-full object-cover"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbPN0dWp6JdwT6VUbdob_k6ZnMT5FjJvQ3Nnb9R2cRGi662vaqbCoKY8Hep8XPKpFofnyZSGPEmn6YpcCoPS6qioBAu9uBjnOxADFzSa4g57AYflDkCoYAGW93TZIkt9_IRAlr2xw0SVTr1QugyhQ9sNsBbXTByYwxod7t9XsrueILLxTCK66jOuOmt7MDdNtWDVvl3-HoTB-oJQMa7mRxlR9i4c99hqmOlDDE9IFUKNg36aeh6UBLTRp_w__t-QiIQBkgR-dHDCwE" />
                        </div>
                        <div>
                            <p class="font-headline font-semibold text-on-surface">Alex Dev</p>
                            <p class="text-xs text-secondary font-medium">Pro Member</p>
                        </div>
                    </div>
                    <div class="space-y-2">
                        <a class="flex items-center gap-3 px-4 py-3 text-slate-600 hover:translate-x-1 transition-transform rounded-xl hover:bg-white/50 group"
                            href="{{ url('/courses') }}">
                            <span
                                class="material-symbols-outlined text-xl group-hover:text-primary transition-colors">school</span>
                            <span class="text-sm font-medium">Courses</span>
                        </a>
                        <a class="flex items-center gap-3 px-4 py-3 text-slate-600 hover:translate-x-1 transition-transform rounded-xl hover:bg-white/50 group"
                            href="{{ url('/playground') }}">
                            <span
                                class="material-symbols-outlined text-xl group-hover:text-primary transition-colors">code_blocks</span>
                            <span class="text-sm font-medium">Playground</span>
                        </a>
                        <a class="flex items-center gap-3 px-4 py-3 bg-white text-cyan-600 shadow-sm rounded-xl"
                        ...
                        <a class="flex items-center gap-3 px-4 py-3 text-slate-600 hover:translate-x-1 transition-transform rounded-xl hover:bg-white/50 group"
                            href="{{ url('/community') }}">
                            <span
                                class="material-symbols-outlined text-xl group-hover:text-primary transition-colors">group</span>
            ...
            <section class="flex-1 space-y-12 pb-24">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div class="space-y-2">
                        <span
                            ...
                            Profile</span>
                        <h2 class="text-4xl md:text-5xl font-bold font-headline tracking-tight text-on-surface">Alex Dev
                        </h2>
                        <p class="text-secondary max-w-md">Senior Frontend Engineer & Cloud Architect.</p>
                    </div>
                    <div class="flex items-center gap-4">
                        <button
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <!-- Achievements Wall -->
                    <div class="lg:col-span-1 bg-surface-container-low rounded-2xl p-8 space-y-6"
                        id="section_certifications">
                        <h3 class="text-xl font-bold font-headline">Achievements</h3>
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <span class="text-[10px] text-center font-bold text-secondary uppercase">Code
                                    Master</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="md:col-span-1 bg-surface-container-low p-6 rounded-xl">
                            <div
                                ...
                                <div class="relative group">
                                    <div class="w-32 h-32 rounded-full overflow-hidden ring-4 ring-primary-container">
                                        <img alt="Avatar" class="w-full h-full object-cover"
                                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuB8EdZlrbo0o9nwFY0zSmY93I38dVbrqfLBY4GNeDDbVTYlagWtEm0j_dlgoS0_dEdMOG50lA7rN2D1iI7T-s9qGURiSfbEyLBVS8qbgBCfXzvrQVF-MK3ayWZVMo9DeoX5x1MtneM35Wlnc6kKnl1aVlGc6KX8KZU6mMkxPNtaTeiFEHqLk0If17GtgFnsUyYlXYQQTHFyAJIQasvkumG4XcBLFhokB6B1THggxFP968kE34_MJrZjB2ahlUPlTnW0iMyucdqO-WRO" />
                                    </div>
                                </div>
                                <div>
                                ...
                                <button
                                    class="w-full py-2 bg-secondary-container text-on-secondary-container rounded-lg font-label text-sm hover:bg-surface-container-high transition-colors">Replace</button>
                            </div>
                        </div>
                        <div class="md:col-span-2 bg-surface-container-low p-6 rounded-xl space-y-6">
                            <div class="bg-surface-container-lowest p-6 rounded-lg">
                                ...
                                <div class="space-y-4">
                                    <input class="w-full border p-3 rounded-xl" type="text" value="Alex Rivera" />
                                    <input class="w-full border p-3 rounded-xl" type="email"
                                        value="alex.rivera@devrak.io" />
                                </div>
                            </div>
                            <div class="bg-surface-container-lowest p-6 rounded-lg">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        <label
                                            class="font-label text-xs font-semibold text-on-surface-variant px-1">ROLE</label>
                                        <select
                                    ...
                                    <div class="space-y-1">
                                        <label
                                            class="font-label text-xs font-semibold text-on-surface-variant px-1">LOCATION</label>
                                        <input
                                            ...
                                            type="text" value="San Francisco, CA" />
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-end gap-4 pt-4">
                                <button class="px-6 py-2.5 bg-primary text-on-primary rounded-xl font-bold">Save
                                    Changes</button>
                            </div>
                        </div>
                        <!-- Professional Info -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 hidden lg:col-span-3"
                        ...
                        <section
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <button
                                    class="group relative flex flex-col items-center gap-4 p-4 rounded-xl border-2 border-primary ring-offset-4 ring-primary-container/20 transition-all">
                                    <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="font-medium text-primary">Light Mode</span>
                                    </div>
                                </button>
                                <button
                                    class="group relative flex flex-col items-center gap-4 p-4 rounded-xl border-2 border-transparent hover:bg-surface-container-low transition-all">
                                    <div
                ...
                <div class="bg-surface-container-lowest rounded-3xl p-10 border border-outline-variant/10">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div class="text-center md:text-left">
                            <p class="text-[10px] uppercase tracking-widest font-bold text-secondary mb-2">Kinetic Score
                            </p>
                            <p class="text-3xl font-bold font-headline">94 <span
                                    class="text-sm font-medium text-primary-dim">/ 100</span></p>
                        </div>
                        <div class="text-center md:text-left">
